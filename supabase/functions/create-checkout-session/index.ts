...
// For LIVE mode: Set STRIPE_SECRET_KEY=sk_live_xxx in Supabase project settings
// For TEST mode: Set STRIPE_SECRET_KEY=sk_test_xxx in Supabase project settings
...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    console.log('Parsed data - ticketQuantity:', ticketQuantity, 'movieDetails:', movieDetails)
    ...
    const lineItems = [{
      price_data: {
        ...
        product_data: {
          ...
          description: `${movieDetails.date} at ${movieDetails.time} - ${movieDetails.venue}`,
        },
